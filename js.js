...
document.querySelector(".galleri img:nth-child(1)").addEventListener("click", visRet1);
document.querySelector(".galleri img:nth-child(2)").addEventListener("click", visRet2);
document.querySelector(".galleri img:nth-child(3)").addEventListener("click", visRet3);
document.querySelector(".galleri img:nth-child(4)").addEventListener("click", visRet4);
document.querySelector(".galleri img:nth-child(5)").addEventListener("click", visRet5);
document.querySelector(".galleri img:nth-child(6)").addEventListener("click", visRet6);
...
function visRet1() {
    tallerkenlag.src = "img/japanret.png"; // Sætter src-attributten til japanret.png
...
function visRet2() {
    tallerkenlag.src = "img/okonomiyaki.png"; 
    tallerkenlag.style.display = "block";
}

function visRet3() {
    tallerkenlag.src = "img/risogkarry.png"; 
    tallerkenlag.style.display = "block";
}

function visRet4() {
    tallerkenlag.src = "img/rejer.png"; 
    tallerkenlag.style.display = "block";
}

function visRet5() {
    tallerkenlag.src = "img/nudler.png"; 
    tallerkenlag.style.display = "block";
}

function visRet6() {
    tallerkenlag.src = "img/japanret.png"; 
    tallerkenlag.style.display = "block";
}